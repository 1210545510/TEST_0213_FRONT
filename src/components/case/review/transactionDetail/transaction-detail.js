...
export const caseReviewTransactionDetail = {
  template,

  name: 'caseReviewTransactionDetail',
  ...
  data () {
    return {
      ...
      transactionNum: {
        listSwitch1: ['Weekly', 'Monthly'], // Day/Mont/Week
        type1: 1,
        date: '' // 时间段
      },
      transactionHistory: {
  ...
  mounted () {
    ...
    if (common.isLogin()) {
      if (this.reviewId && this.originalId) {
        ...
        common.warningInfoTip('Original/Case ID Is Not Find!')
      }
