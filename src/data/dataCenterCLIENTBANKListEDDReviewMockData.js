...
module.exports = {
  ...
  // 拆线图处数据3
  chartLegendData3: ['Total number of drafted cases pending SAR QA', 'Total number of assigned cases pending SAR analysts investigation', 'Total number of cases pending assignment to SAR', 'Total number of referrals to the SAR Team'],
  chartSeriesData3: [
    {
  ...
  // 拆线图处数据6
  chartLegendData6: ['Total number of SARs filed on subjects using each correspondent bank and trend analysis'],
  chartSeriesData6: [
    {
      name: 'Total number of SARs filed on subjects using each correspondent bank and trend analysis',
      type: 'bar',
      stack: '',
      data: [1203, 1532, 1071, 1234, 990, 2430, 2610, 1071, 1834, 990, 2430, 2120]
    }
  ...
  // 拆线图处数据7
  chartLegendData7: ['Number of alerts automatically waived', 'Number and percentage of alerts automatically waived but rejected by alert QA', 'Number of cases with SAR filed versus', 'Number of cases waived and trend analysis'],
  chartSeriesData7: [
    {
